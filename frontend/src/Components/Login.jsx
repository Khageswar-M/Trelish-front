    ...
    return (
        <>
            <AnimatePresence>
                ...
                {
                    isInvalid && (
                        <div id="toast-success" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800" role="alert"
                            style={{
                                display:"flex",
                                position: "absolute",
                                left: "50%",
